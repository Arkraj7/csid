  ...
  return (
    <section className="py-20 md:py-28 bg-muted/30">
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* TOP SECTION: Based exactly on your sketch layout */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-16 bg-card p-8 md:p-10 rounded-3xl border border-border shadow-md">
          ...
          <div className="w-full md:w-auto md:text-right border-t md:border-t-0 md:border-l border-border pt-6 md:pt-0 md:pl-10">
            <p className="text-sm text-muted-foreground mb-4 max-w-[200px] hidden md:block">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {[
                { icon: BookOpen, text: 'Published Climate Frameworks' },
                { icon: FileText, text: 'Peer-Reviewed Research' },
                { icon: Globe, text: 'Global Policy Documents' },
                { icon: Landmark, text: 'Multilateral Fund Guidelines' },
              ].map((item, idx) => (
          ...
          {/* Right Side: New Clean Graphic Box */}
          <div className="bg-card border border-border shadow-xl rounded-3xl p-12 text-center flex flex-col items-center justify-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="text-6xl font-black text-primary mb-2">6</div>
              <p className="text-xl text-foreground font-bold mb-2">Comprehensive Modules</p>

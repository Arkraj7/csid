...
const testimonials = [
  {
    quote:
      'The ATF™ course completely changed how I think about climate investment. The four-pillar framework is something I now apply in my daily work. The chapter quizzes really lock in the knowledge.',
    initials: 'AK',
  ...
  {
    quote:
      'I had no background in climate finance and was worried the content would be too technical. CSID breaks it down beautifully — the Gold Coast case study in Chapter 9 was especially eye-opening.',
    initials: 'RV',
  ...
  {
    quote:
      'The capital imbalance data in Chapter 5 was genuinely shocking — $1.3 trillion going to mitigation versus $76 billion to adaptation. CSID makes these numbers understandable and actionable.',
    initials: 'PM',
    name: 'Priyanka Mehra',
  ...
  {
    quote:
      'Clean interface, well-structured chapters, and the 70% quiz threshold keeps you honest. I appreciated that the certificate actually requires you to demonstrate understanding — not just click through.',
    initials: 'SN',
    name: 'Siddharth Nair',
  ...
  {
    quote:
      'The Efficient Frontier concept in Chapter 7 is something I have been trying to explain to clients for years. CSID explains it in a way that a non-technical audience can actually grasp. Excellent platform.',
    initials: 'KS',
    ...
    <section className="py-24 bg-background overflow-hidden relative border-t border-border">
      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 mb-16 text-center">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          From ESG analysts to urban planners — CSID learners come from every corner of the climate
          economy.
        </p>
      </div>
            ...
            >
              <div className="h-full bg-card border border-border rounded-3xl p-8 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col justify-between cursor-default">
                ...
                <div className="flex items-center gap-4">
                  <div
                    className={`w-14 h-14 rounded-2xl flex items-center justify-center font-bold text-lg ${testimonial.color}`}
                  >

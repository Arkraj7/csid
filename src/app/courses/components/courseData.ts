...
export const chapters: Chapter[] = [
  {
    ...
    content: [
      ...
      'These four pillars form what the Adaptive Thematic Framework™ calls the Climate Evolution Cycle. Yet adaptation finance accounts for less than 10% of global climate investment, and resilience and recovery capital remain fragmented and underrepresented.',
      'This course introduces the Climate Economy Efficient Frontier and the Adaptive Thematic Framework™ — a proprietary capital allocation model developed by Arciteq Capital to address this structural imbalance.',
    ],
    keyStats: [
    ...
    quiz: [
      ...
      {
        id: 'q1-4',
        question: 'What is the name of the capital allocation framework introduced in the paper?',
        options: ['Climate Policy Initiative', 'Adaptive Thematic Framework™', 'ESG Frontier Model', 'Green Economy Protocol'],
        correctIndex: 1,
      },
      {
        id: 'q1-5',
        question: 'Which organisation developed the Adaptive Thematic Framework™?',
        options: ['UNEP', 'World Economic Forum', 'Arciteq Capital', 'Climate Policy Initiative'],
        correctIndex: 2,
      },
    ],
  },

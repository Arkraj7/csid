...
export const courseData: Course = {
  ...
  chapters: [
    ...
    },
    {
      ...
      content:
        '<h2>Multilateral Fund Guidelines</h2><p>This final chapter explores the guidelines set forth by major multilateral funds. Understanding these documents is crucial for effectively navigating the climate economy and securing project funding.</p><br/><p>Congratulations on reaching the end of the reading material! You are now ready to take the final assessment.</p>',
      order: 3,
      duration: 20,
      previousChapter: 'frameworks',
    },
  ],
};
